...
GROQ_API_KEY = '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'
...
print("Model Loaded")
template = """
You are a Urban Development and Sustainability Professional. Strictly use the tone of a professional.
